...
import { ACTOR_ID } from '../ApifyRapidApiMarketplace.node';
import { buildActorInput } from '../ApifyRapidApiMarketplace.properties';
...
/**
 * Shape a single API row according to the chosen Output mode.
...
function shapeItem(
	...
	return {
		...
		avgSuccessRate: item.avgSuccessRate,
